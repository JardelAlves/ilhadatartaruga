...
function modoGRUfun() {
	...
	// Evita que trocar de state sem clicar nas imagens apague elas
	if(residuosCriados == true) {residuosCriados = false;}
	
	// Indica em que modo está
	modoGRU = true; 
	modoAGRO = false; 
	modoGTAR = false;
...
function destroyesgoto() {
	if(recmissao3GTAR == true && recmissao4GTAR == true) {esgoto.destroy();}	
}